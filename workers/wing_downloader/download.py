"""
Wing downloader worker entry point.
...
ADAPTER_MAP = {
    "rocket_growth_inventory_status": "adapters.rocket_growth_inventory_status",
}
...
def main():
    ...
    # Immediately clear sensitive value from memory after reading
